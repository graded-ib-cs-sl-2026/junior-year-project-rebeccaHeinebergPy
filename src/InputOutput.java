// This code was copied from the madlibs project we did in class since it serves the same purpose 
// Allows the code to print out messages with io.output 
...
public class InputOutput {
    ...
    public int inputInt() {
        ...
        // I added this so that I can also input output int values as well as String values
    }
